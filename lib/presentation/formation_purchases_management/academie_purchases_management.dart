...
/// Validation des demandes d'achat "Académie Matières Premières"
/// (06/08) — voir supabase/phase81_patch_academie_matieres_premieres.sql.
/// Accès payant DISTINCT de l'achat de la fiche produit
/// (formation_purchases_management.dart) : même flux de validation
/// manuelle (référence + preuve), mais sa propre table et ses propres
/// paliers de prix, revenu séparé.
class AcademiePurchasesManagement extends StatefulWidget {
  const AcademiePurchasesManagement({super.key});

  @override
  State<AcademiePurchasesManagement> createState() =>
      _AcademiePurchasesManagementState();
}

class _AcademiePurchasesManagementState
    extends State<AcademiePurchasesManagement> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      setState(() {
        _isLoading = false;
        _error =
            'Impossible de charger les achats (migration phase81 exécutée ?).';
      });
    }
  }
  ...
  /// liste plutôt qu'un objet — ce cast tolère les deux formes.
  ...
  Widget build(BuildContext context) {
    ...
    try {
      ...
      buildError = 'Erreur d\'affichage (Académie) : $e';
    }
