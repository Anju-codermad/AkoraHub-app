-- ============================================================
-- AkoraHub - Patch Phase 237 : resynchronise products.use_cases pour
-- "Bicarbonate de soude" après la création de sa fiche Académie
-- (phase236) — même décalage déjà rencontré pour le Sulfate
-- d'aluminium (phase198) : le trigger sync_product_from_raw_material
-- ne remplit use_cases qu'à la création du produit, pas quand on
-- ajoute des usages à une fiche Académie déjà liée à un produit
-- existant.
--
