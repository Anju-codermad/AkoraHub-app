...
| 235 | `phase235_lien_bicarbonate_soude_akoreau.sql` | relie "Bicarbonate de sodium technique" (grade technique, Akora Pro) à Akor'Eau, catégorie "Correction du pH" (les grades alimentaires étaient déjà reliés à Akora NutriLab depuis les phases 205/208) — ⚠️ suppose que la phase240 a déjà été exécutée |
| 236 | `phase236_fiche_bicarbonate_soude_technique.sql` | fiche Académie complète pour "Bicarbonate de sodium technique" (CAS, dosages détaillés eau/piscine/nettoyage/neutralisation, sans dupliquer le contenu alimentaire déjà sur les fiches E500(ii)/alimentaire) — ⚠️ suppose que la phase240 a déjà été exécutée |
| 237 | `phase237_resync_usages_bicarbonate_soude.sql` | corrige le décalage products.use_cases vs fiche Académie pour "Bicarbonate de sodium technique", même correctif que la phase198 |
| 238 | `phase238_correction_dosage_et_nouveaux_usages_bicarbonate_soude.sql` | corrige le dosage piscine (TAC) de la fiche "Bicarbonate de sodium technique" (150 g/m³ de la phase236 était erroné d'un facteur ~10 ; recoupement avec la règle professionnelle piscine et le calcul stœchiométrique confirme 15-18 g/m³) et ajoute 2 usages (détergents industriels, agriculture) |
